import { BUSCAR_COLETA, COLETA_CHECKOUT_UNIDADE, COLETA_CHECKIN_UNIDADE, COLETA_BUSCAR_PRODUTOS, COLETA_ATUALIZAR_STATUS, COLETA_CHECKIN_CLIENTE, COLETA_CHECKOUT_CLIENTE } from "@constants/";
...
export const coletaCheckInCliente = actionFetchItem(COLETA_CHECKIN_CLIENTE, "coleta/checkin");
...
export const coletaBuscarProdutos = actionFetchItem(COLETA_BUSCAR_PRODUTOS, "coleta/produtos", false, false);

export const actionBuscarColeta = actionFetchItem(BUSCAR_COLETA, "coleta/get", false);
