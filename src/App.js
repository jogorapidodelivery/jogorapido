...
import Coletar from '@screens/coleta-entrega';
import ColetaCheckoutUnidade from '@screens/coleta-entrega/screens/checkout-estabelecimento';
import ColetaCheckoutCliente from '@screens/coleta-entrega/screens/checkout-cliente';
import ColetaPagamento from '@screens/coleta-entrega/screens/pagamento';
...
SDNavigation.registerScreens({
  ...
  checarTokenEmailGoRecuperarSenha: {
    name: 'checarTokenEmailGoRecuperarSenha',
    screen: ChecarTokenEmailGoRecuperarSenha,
  },
  checarTokenEmailGoHome: {
    name: 'checarTokenEmailGoHome',
    screen: ChecarTokenEmailGoHome,
  },
  ...
  coletaCheckoutUnidade: {
    name: 'coletaCheckoutUnidade',
    screen: ColetaCheckoutUnidade,
  },
  coletaCheckoutCliente: {
    name: 'coletaCheckoutCliente',
    screen: ColetaCheckoutCliente,
  },
  coletaPagamento: {name: 'coletaPagamento', screen: ColetaPagamento},
  meusDadosChecarTokenEmail: {
    name: 'meusDadosChecarTokenEmail',
    screen: MeusDadosChecarTokenEmail,
  },
  meusDadosAlterarSenha: {
    name: 'meusDadosAlterarSenha',
    screen: MeusDadosAlterarSenha,
  },
});
