...
export const actionCheckInUnidade = ({coleta_ids, entregador_id, dentroDoRaio, raio}) => {
    ...
    if (dentroDoRaio) {
        ...
        push("alerta", {
            params: {
                titulo: "JogoRápido",
                mensagem: `Só é possivel fazer checkin no estabelecimento à uma distância máxima de ${km2String(raio)}.`
            }
        })
    }
}
