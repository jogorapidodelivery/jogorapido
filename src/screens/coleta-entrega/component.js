...
import { SafeAreaView, FlatList, ImageBackground, RefreshControl } from 'react-native';
...
function MinhasColetasComponent({data, refreshing, onRefresh, filter, updateFilter}) {
  ...
  >
      <SafeAreaView style={styl.container}>
        ...
        <FlatList
          ...
          ListFooterComponent={<Button onPress={whatsapp} style={styl.btnAjuda} text={{ value: "Preciso de ajuda", color: "07" }} leftIcon={{ value: "", color: "07" }} styleName="pequeno" bg="09" />}
