...
export default class Home extends PureComponent {
  ...
  render() {
    const {
      navigation,
      sd: {entregador_id, coletaFilter, coleta_ids, tituloColetas},
    } = this.props;
    ...
    const total_frete_semana = getItemByKeys(
      this.props,
      'sd.total_frete_semana',
    );
