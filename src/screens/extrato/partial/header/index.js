...
export default class Header extends PureComponent {
  ...
  _renderLineHeader = (icone, titulo, data = undefined) => (
    <View style={styl.warpLine}>
  ...
  render() {
    ...
    const pos = filtros.findIndex(({actived}) => actived);
    return (
      <Fragment>
        ...
        <View style={styl.warpMoney}>
          ...
          <Text style={stylDefault.span}>
            R$ <Text style={styl.preco}>{total_mes_atual}</Text>
          </Text>
        </View>
