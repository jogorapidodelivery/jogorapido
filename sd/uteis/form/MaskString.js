...
export const formataCampo = (v, m, limited) => {
  ...
  if (isNaN(Number(r.charAt(r.length - 1)))) {
...
export const cpfCnpj = v => {
  ...
  if (v.length > 11) {
    ...
    return formataCampo(v, '000.000.000-00', false);
  }
};
export const moeda = (v, simbolo = 'R$ ', ignorarCentavos = false) => {
  ...
  if (ignorarCentavos) {
    return _r.substring(0, _r.length - 3);
  }
  return _r;
};
