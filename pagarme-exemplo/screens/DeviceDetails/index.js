...
// to store secrets.
const credentials = {
  apiKey: 'ak_test_dMh36Tfs8WR8uuSbBU4KNVZ1LyxVtA',
  encryptionKey: 'ek_test_Pf8ZLndl37m9SgPh5rYsXuhIZ90nzX',
};
  ...
  const onSubmitAmount = () => {
    mpos.addListeners({
      ...
      receiveNotification: notification => {
        console.log(
          `[${selectedDevice.name}] Sent notification: `,
          notification,
        );
      },
      ...
      receiveTableUpdated: () => {
        setTransactionStatus(
          'Emv tables are up to date. Insert credit card...',
        );
